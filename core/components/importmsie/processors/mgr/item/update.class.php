...
class importMsieItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('importmsie_item_err_ns');
        }
...
return 'importMsieItemUpdateProcessor';
